 ...
 * @version (5/8/2018)
 */
public class Cave2 extends World
{
    ...
    {    
        ...
        setPaintOrder(/*Barrier.class,*/ Icons.class, DialogParts.class, MusicButton.class, Treetop.class, Player.class, 
            JimboSubSystem.class, BensSubSystem.class, MattsSubSystem.class, Loot.class, Treebase.class, Shadow.class, BG.class, Barrier.class, ShopDoorExit.class, InstructionParts.class);
    }
    ...
    {
        Cave2Exit cave2exit = new Cave2Exit();
        addObject(cave2exit,508,729);
        ...
        addObject(princessanna,790,192);
        Pirate pirate = new Pirate(true);
        addObject(pirate,662,251);
        BlackKnight blackknight = new BlackKnight(true);
        addObject(blackknight,443,262);
        BlackKnight blackknight2 = new BlackKnight(true);
        addObject(blackknight2,532,437);
    }
}