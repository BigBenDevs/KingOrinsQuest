 ...
 * @version 4/30/18
 */
public class Villager8 extends Villager
{
    ...
    public Villager8()
    {
        setImage("char/Danzig/Danzig_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/Danzig/Danzig_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
