 ...
 * @version (5/8/2018)
 */
public class World18 extends World
{
    private boolean angry;
    private int bX;
    private int bY;
    public static int archerCount = 3;
    public static int spearmanCount = 1;
    public static int blackKnightCount = 0;
    public static int fighterCount = 0;
    /**
     * Constructor for objects of class World18.
     * 
     */
    public World18()
    {    
        ...
        MainWorld.topWorldID = 13;
        MainWorld.leftWorldID = 17;
        MainWorld.rightWorldID = 19;
        MainWorld.bottomWorldID = 23;
        prepare();
        setup();
        spawnPlayer();
