 ...
 * @version 4/30/18
 */
public class Villager12 extends Villager
{
    ...
    public Villager12()
    {
        setImage("char/BlondScientist/BlondScientist_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/BlondScientist/BlondScientist_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
