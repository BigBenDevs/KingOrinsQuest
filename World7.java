...
public class World7 extends World
{
    ...
    {    
        ...
        MainWorld.topWorldID = 2;
        MainWorld.leftWorldID = 6;
        MainWorld.rightWorldID = 8;
        MainWorld.bottomWorldID = 12;
        prepare();
        setup();
        spawnPlayer();
    ...
    private void setup()
    {
        ...
        while(c < blackKnightCount)
        {
            if(getObjectsAt(bX, bY, Barrier.class) != null)
            {
                ...
                int x = Greenfoot.getRandomNumber(450);
                int y = Greenfoot.getRandomNumber(450);
                addObject(new BlackKnight(true), x, y);
                c++;
            }
        }
        int d = 0;
