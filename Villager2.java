 ...
 * @version 4/30/18
 */
public class Villager2 extends Villager
{
    ...
    public Villager2()
    {
        setImage("char/NickelBack/NickelBack_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/NickelBack/NickelBack_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
