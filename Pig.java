...
/**
 * Pig walks around just doing their own thing.
 * 
...
public class Pig extends Animals
{
    ...
    public Pig()
    {
        setImage("/char/Pig/Pig_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("/char/Pig/Pig_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
