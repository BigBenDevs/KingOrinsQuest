 ...
 * @version 4/30/18
 */
public class Villager3 extends Villager
{
    ...
    public Villager3()
    {
        setImage("char/RedBandana/RedBandana_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/RedBandana/RedBandana_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
