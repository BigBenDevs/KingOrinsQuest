...
public class World3 extends World
{
    ...
    public static int fighterCount = 2;
    /**
    ...
    {    
        ...
        MainWorld.leftWorldID = 2;
        MainWorld.rightWorldID = 4;
        MainWorld.bottomWorldID = 8;
        prepare();
        setup();
        spawnPlayer();
    ...
    private void prepare()
    {
        ...
        addObject(templatebg2,574,496);
        templatebg2.setLocation(543,461);
