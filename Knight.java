...
/**
 * The Knight safeguards the Kingdom.
 * 
...
public class Knight extends Villager
{
    ...
    /**
     * Knight constructor. Sets initial image.
     */
    public Knight()
    {
        setImage("char/NormalKnight/NormalKnight_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/NormalKnight/NormalKnight_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
