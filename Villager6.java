 ...
 * @version 4/30/18
 */
public class Villager6 extends Villager
{
    ...
    public Villager6()
    {
        setImage("char/YellowVest/YellowVest_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/YellowVest/YellowVest_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
