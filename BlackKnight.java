...
/**
 * The Black Knight wants to destroy the main character!
 * 
 * @author Anthony Neeser
 * @version 4/30/18
 */
public class BlackKnight extends Melee
{
    ...
    private String classType = "wizard"; //"archer", "spearman", "melee"
    private String projectile = "fireball"; // "arrow", "spear"
    private int projectileWidth = 20;
    private int projectileHeight = 20;
    private int shotSpeed = 10;
    private int removalCount = 25;
    private int reloadDelay = Greenfoot.getRandomNumber(200)+100; //Adds delay to reload so that each enemy is different.
    ...
    private int ice;
    /**
     * BlackKnight constructor sets initial image, and sets angry to value of variable passed to constructor.
     */
    public BlackKnight(boolean angry)
    {
        this.angry = angry;
        setImage("char/BlackKnight/BlackKnight_Front.png");
    }
