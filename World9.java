...
public class World9 extends World
{
    ...
    private int bX;
    private int bY;
    public static int archerCount = 4;
    ...
    {    
        ...
        MainWorld.topWorldID = 4;
        MainWorld.leftWorldID = 8;
        MainWorld.rightWorldID = 10;
        MainWorld.bottomWorldID = 14;
        prepare();
        setup();
        spawnPlayer();
