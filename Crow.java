...
/**
 * Crow walks around just doing their own thing.
 * 
...
public class Crow extends Animals
{
    ...
    public Crow()
    {
        setImage("char/Crow/Crow_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/Crow/Crow_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
