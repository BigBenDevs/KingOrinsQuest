 ...
 * @version 4/30/18
 */
public class Villager1 extends Villager
{
    ...
    public Villager1()
    {
        setImage("char/BrownHairBlueCoat/BrownHairBlueCoat_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/BrownHairBlueCoat/BrownHairBlueCoat_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
