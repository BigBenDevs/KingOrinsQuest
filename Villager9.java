 ...
 * @version 4/30/18
 */
public class Villager9 extends Villager
{
    ...
    public Villager9()
    {
        setImage("char/BusinessPonytail/BusinessPonytail_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/BusinessPonytail/BusinessPonytail_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
