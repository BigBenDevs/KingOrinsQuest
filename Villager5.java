 ...
 * @version 4/30/18
 */
public class Villager5 extends Villager
{
    ...
    public Villager5()
    {
        setImage("char/Sephiroth/Sephiroth_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/Sephiroth/Sephiroth_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
