...
/**
 * Chloe loves mushrooms.
 * 
 * @author Anthony Neeser
 * @version 4/30/18
 */
public class Chloe extends Villager
{
    ...
    /**
     * Chloe constructor. Sets initial image.
     */
    public Chloe()
    {
        setImage("char/PurpleDress/PurpleDress_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/PurpleDress/PurpleDress_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
            stepDelay, dirSwitch, mcRange, angry, classType, projectile, projectileWidth, projectileHeight, 
            shotSpeed, removalCount, reloadDelay);
        genericDialog("chloe");
    }
}