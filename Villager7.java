 ...
 * @version 4/30/18
 */
public class Villager7 extends Villager
{
    ...
    public Villager7()
    {
        setImage("char/GirlScout/GirlScout_Front.png");
    }
    ...
    public void act() 
    {
        variablePass("char/GirlScout/GirlScout_", imgChangeDelay, shadowImageWidth, shadowImageHeight, shadowX, shadowY, shadowWidth, shadowHeight, 
