 ...
 * @version (5/8/2018)
 */
public class World17 extends World
{
    private boolean angry;
    private int bX;
    private int bY;
    public static int archerCount = 2;
    public static int spearmanCount = 2;
    public static int blackKnightCount = 0;
    public static int fighterCount = 0;
    /**
     * Constructor for objects of class World17.
     * 
     */
    public World17()
    {    
        ...
        MainWorld.topWorldID = 12;
        MainWorld.leftWorldID = 16;
        MainWorld.rightWorldID = 18;
        MainWorld.bottomWorldID = 22;
        prepare();
        setup();
        spawnPlayer();
